...
set terminal pdfcairo size 7in,4.2in font "Gill Sans,9" linewidth 4 rounded fontscale 1.0 dashed
...
set style line 5 lt rgb "#A00000" lw 2 pt 1 dt 4
set style line 6 lt rgb "#00A000" lw 2 pt 6 dt 4
######################################################################
...
plot \
        ...
        'l2/apache.with-cst-lock/ApacheMon.dat' index 0 title 'nVM-cst' with lp linecolor 5,\
        'l1/apache.with-cst-lock/ApacheMon.dat' index 0 title 'VM-cst' with lp linecolor 6
